    ...
    <div v-show="!visible"  id="save" >
      <div class="save">
        <el-tabs v-model="activeName" @tab-click="handleClick" tab-position="top"  type="border-card"  >
          <el-tab-pane label="新增" name="save"  key="save">
      ...
      <el-button @click="visible = true" style="margin:0 auto">返回</el-button>
...
<style>
  ...
  .save .el-card ,.save .is-always-shadow{
    margin-top:50px;
  }
  .save .site-content--tabs > .el-tabs .el-tabs__content {
    margin-top: 43px;
  }
  #save .el-tabs__header{
    top:100px;
  ...
  #pane-generatortemplate .el-card {
    margin-top: 50px;
  }
</style>
