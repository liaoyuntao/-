<template>
  <div class="mod-config">
    <tablefield :pathUrl="pathUrl" ref="tablefield" :saveForm="saveForm":formButton="formButton" :dataForm.sync="dataForm"  :setListSelections="setListSelections"  :model="model" :operation.sync="operation"></tablefield>
  </div>
</template>
