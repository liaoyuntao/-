<template>
  <div class="mod-config">
    ...
    <tablefield :pathUrl="pathUrl" ref="tablefield" :dataForm.sync="dataForm"  :setListSelections="setListSelections"  :model="model" :operation.sync="operation" :saveForm="saveForm"></tablefield>
  </div>
</template>
