<template>
  <div class="mod-config">
    <tablefield :pathUrl="pathUrl" ref="tablefield" :dataForm.sync="dataForm" :formButton="formButton":saveForm="saveForm" :setListSelections="setListSelections"  :model="model" :operation.sync="operation"></tablefield>
  </div>
</template>
...
<script>
  ...
  export default {
    ...
    data () {
      return {
        model: 'generator',
        pathUrl: 'generatortemplateconfig',
