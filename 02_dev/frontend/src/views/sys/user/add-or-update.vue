          ...
          if (this.dataForm.id) {
            API.user.info(this.dataForm.id).then(({data}) => {
              if (data && data.code === 0) {
                ...
                this.dataForm.remarks = data.user.remarks
                this.dataForm.versionNo = data.user.versionNo
                ...
                this.dataForm.deleteFlag = data.user.deleteFlag
                this.dataForm.sort = data.user.sort
              }
            })
          }
        })
