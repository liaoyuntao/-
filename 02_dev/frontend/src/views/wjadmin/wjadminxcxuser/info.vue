    ...
    <el-dialog
        ...
        <el-form :model="dataForm" :rules="dataRule" ref="dataForm" @keyup.enter.native="dataFormSubmit()" label-width="80px">
                    ...
                    <el-form-item label="用户标识" prop="openid">
                                                            <el-input v-model="dataForm.openid" placeholder="用户标识"></el-input>

                    </el-form-item>
                    <el-form-item label="用户昵称" prop="name">
                                                            <el-input v-model="dataForm.name" placeholder="用户昵称"></el-input>

                    </el-form-item>
                    <el-form-item label="用户头像" prop="pic">
                                                            <el-input v-model="dataForm.pic" placeholder="用户头像"></el-input>
        ...
        methods: {
            init (id) {
                ...
                this.$nextTick(() => {
                    ...
                    if (this.dataForm.id) {
                        API.wjadminxcxuser.info(this.dataForm.id).then(({data}) => {
                            if (data && data.code === 0) {
            ...
            dataFormSubmit () {
                this.$refs['dataForm'].validate((valid) => {
                    ...
                    var tick = !this.dataForm.id ? API.wjadminxcxuser.add(params) : API.wjadminxcxuser.update(params)
                    tick.then(({data}) => {
                        if (data && data.code === 0) {
                            this.$message({
                                    message: '操作成功',
