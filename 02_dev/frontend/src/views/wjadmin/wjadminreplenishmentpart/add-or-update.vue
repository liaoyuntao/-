    ...
    export default {
        data () {
            return {
                ...
                pathUrl:'wjadminreplenishmentpart',
        ...
        methods: {
            ...
            init (id) {
                ...
                this.$nextTick(() => {
                    ...
                    if (id) {
                        API.wjadminreplenishmentpart.info(id).then(({data}) => {
                            if (data && data.code === 0) {
            ...
            dataFormSubmit () {
                this.$refs['dataForm'].validate((valid) => {
                    ...
                    var tick = !this.dataForm.id ? API.wjadminreplenishmentpart.add(params) : API.wjadminreplenishmentpart.update(params)
                    tick.then(({data}) => {
                        if (data && data.code === 0) {
                            this.$message({
                                    message: '操作成功',
