    ...
    <el-dialog
        ...
        <el-form :model="dataForm" :rules="dataRule" ref="dataForm" @keyup.enter.native="dataFormSubmit()" label-width="80px">
                    ...
                    <el-form-item label="分类id" prop="goodsCategoryId">
                                                            <el-input v-model="dataForm.goodsCategoryId" placeholder="分类id"></el-input>
                    ...
                    <el-form-item label="首页推荐@0-是,1-否" prop="isRecommend">
                                                            <el-input v-model="dataForm.isRecommend" placeholder="首页推荐@0-是,1-否"></el-input>
    ...
    export default {
        data () {
            ...
            dataRule: {
                        ...
                        isRecommend: [
                        { required: true, message: '首页推荐@0-是,1-否不能为空', trigger: 'blur' }
                    ],
            }
        }
        },
        methods: {
            init (id) {
                ...
                this.$nextTick(() => {
                    ...
                    if (this.dataForm.id) {
                        API.wjadmingoods.info(this.dataForm.id).then(({data}) => {
                            if (data && data.code === 0) {
                                        ...
                                        this.dataForm.goodsCategoryId = data.data.goodsCategoryId
            ...
            dataFormSubmit () {
                this.$refs['dataForm'].validate((valid) => {
                    ...
                    var tick = !this.dataForm.id ? API.wjadmingoods.add(params) : API.wjadmingoods.update(params)
                    tick.then(({data}) => {
                        if (data && data.code === 0) {
                            this.$message({
                                    message: '操作成功',
