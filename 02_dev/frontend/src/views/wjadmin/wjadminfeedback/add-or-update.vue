        ...
        methods: {
            ...
            init (id) {
                ...
                this.$nextTick(() => {
                    ...
                    if (id) {
                        API.wjadminfeedback.info(id).then(({data}) => {
                            if (data && data.code === 0) {
            ...
            dataFormSubmit () {
                this.$refs['dataForm'].validate((valid) => {
                    ...
                    var tick = !this.dataForm.id ? API.wjadminfeedback.add(params) : API.wjadminfeedback.update(params)
                    tick.then(({data}) => {
                        if (data && data.code === 0) {
                            this.$message({
                                    message: '操作成功',
