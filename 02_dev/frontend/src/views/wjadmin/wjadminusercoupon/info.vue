    ...
    <el-dialog
        ...
        <el-form :model="dataForm" :rules="dataRule" ref="dataForm" @keyup.enter.native="dataFormSubmit()" label-width="80px">
                    ...
                    <el-form-item label="金额" prop="money">
                                                            <el-date-picker v-model="dataForm.money"  placeholder="金额" type="date" style="width:100%;"></el-date-picker>
                    ...
                    <el-form-item label="到期时间" prop="expirationTime">
                                                            <el-date-picker v-model="dataForm.expirationTime"  placeholder="到期时间" type="date" style="width:100%;"></el-date-picker>
        ...
        methods: {
            init (id) {
                ...
                this.$nextTick(() => {
                    ...
                    if (this.dataForm.id) {
                        API.wjadminusercoupon.info(this.dataForm.id).then(({data}) => {
                            if (data && data.code === 0) {
            ...
            dataFormSubmit () {
                this.$refs['dataForm'].validate((valid) => {
                    ...
                    var tick = !this.dataForm.id ? API.wjadminusercoupon.add(params) : API.wjadminusercoupon.update(params)
                    tick.then(({data}) => {
                        if (data && data.code === 0) {
                            this.$message({
                                    message: '操作成功',
