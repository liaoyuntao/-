    ...
    <el-dialog
        ...
        <el-form :model="dataForm" :rules="dataRule" ref="dataForm" @keyup.enter.native="dataFormSubmit()" label-width="80px">
                    ...
                    <el-form-item label="数量" prop="numbers">
                                                            <el-input v-model="dataForm.numbers" placeholder="数量"></el-input>
        ...
        methods: {
            init (id) {
                ...
                this.$nextTick(() => {
                    ...
                    if (this.dataForm.id) {
                        API.wjadmincart.info(this.dataForm.id).then(({data}) => {
                            if (data && data.code === 0) {
                                        ...
                                        this.dataForm.numbers = data.data.numbers
            ...
            dataFormSubmit () {
                this.$refs['dataForm'].validate((valid) => {
                    ...
                    var tick = !this.dataForm.id ? API.wjadmincart.add(params) : API.wjadmincart.update(params)
                    tick.then(({data}) => {
                        if (data && data.code === 0) {
                            this.$message({
                                    message: '操作成功',
