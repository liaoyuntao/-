...
//import com.szt.modules.wjxcx.entity.WjadminUserAddressEntity;
import com.szt.modules.wjxcx.service.WjadminUserAddressService;
...
@RestController
@RequestMapping("wjxcx/wjadminuseraddress")
@Controller("wjxcxwjadminuseraddress")
public class WjadminUserAddressController {
    ...
    @ApiOperation("列表")
    @GetMapping("/list")
    @RequiresPermissions("wjxcx:wjadminuseraddress:list")
    ...
    @ApiOperation("信息")
    @GetMapping("/info/{id}")
    @RequiresPermissions("wjxcx:wjadminuseraddress:info")
    ...
    @ApiOperation("保存")
    @PostMapping("/save")
    @RequiresPermissions("wjxcx:wjadminuseraddress:save")
    ...
    @ApiOperation("修改")
    @PostMapping("/update")
    @RequiresPermissions("wjxcx:wjadminuseraddress:update")
    ...
    @ApiOperation("删除")
    @PostMapping("/delete")
    @RequiresPermissions("wjxcx:wjadminuseraddress:delete")
