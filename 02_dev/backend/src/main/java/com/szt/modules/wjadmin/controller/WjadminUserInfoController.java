...
@RestController
@RequestMapping("wjadmin/wjadminuserinfo")
@Controller("wjadminwjadminuserinfo")
public class WjadminUserInfoController {
    ...
    @ApiOperation("列表")
    @GetMapping("/list")
    @RequiresPermissions("wjadmin:wjadminuserinfo:list")
    ...
    @ApiOperation("信息")
    @GetMapping("/info/{id}")
    @RequiresPermissions("wjadmin:wjadminuserinfo:info")
    ...
    @ApiOperation("保存")
    @PostMapping("/save")
    @RequiresPermissions("wjadmin:wjadminuserinfo:save")
    ...
    @ApiOperation("修改")
    @PostMapping("/update")
    @RequiresPermissions("wjadmin:wjadminuserinfo:update")
    ...
    @ApiOperation("删除")
    @PostMapping("/delete")
    @RequiresPermissions("wjadmin:wjadminuserinfo:delete")
