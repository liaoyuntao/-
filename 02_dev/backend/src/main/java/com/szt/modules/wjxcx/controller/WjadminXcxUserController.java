...
//import com.szt.modules.wjxcx.entity.WjadminXcxUserEntity;
import com.szt.modules.wjxcx.service.WjadminXcxUserService;
...
@RestController
@RequestMapping("wjxcx/wjadminxcxuser")
@Controller("wjxcxwjadminxcxuser")
public class WjadminXcxUserController {
    ...
    @ApiOperation("列表")
    @GetMapping("/list")
    @RequiresPermissions("wjxcx:wjadminxcxuser:list")
    ...
    @ApiOperation("信息")
    @GetMapping("/info/{id}")
    @RequiresPermissions("wjxcx:wjadminxcxuser:info")
    ...
    @ApiOperation("保存")
    @PostMapping("/save")
    @RequiresPermissions("wjxcx:wjadminxcxuser:save")
    ...
    @ApiOperation("修改")
    @PostMapping("/update")
    @RequiresPermissions("wjxcx:wjadminxcxuser:update")
    ...
    @ApiOperation("删除")
    @PostMapping("/delete")
    @RequiresPermissions("wjxcx:wjadminxcxuser:delete")
