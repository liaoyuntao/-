...
import com.szt.modules.wjadmin.service.WjadminVendingMachineService;
...
@RestController
@RequestMapping("wjadmin/wjadminvendingmachine")
@Controller("wjadminwjadminvendingmachine")
public class WjadminVendingMachineController {
    ...
    @ApiOperation("列表")
    @GetMapping("/list")
    @RequiresPermissions("wjadmin:wjadminvendingmachine:list")
    ...
    @ApiOperation("信息")
    @GetMapping("/info/{id}")
    @RequiresPermissions("wjadmin:wjadminvendingmachine:info")
    ...
    @ApiOperation("保存")
    @PostMapping("/save")
    @RequiresPermissions("wjadmin:wjadminvendingmachine:save")
    ...
    @ApiOperation("修改")
    @PostMapping("/update")
    @RequiresPermissions("wjadmin:wjadminvendingmachine:update")
    ...
    @ApiOperation("删除")
    @PostMapping("/delete")
    @RequiresPermissions("wjadmin:wjadminvendingmachine:delete")
