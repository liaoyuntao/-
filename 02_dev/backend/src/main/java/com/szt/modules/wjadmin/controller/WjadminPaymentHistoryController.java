...
@RestController
@RequestMapping("wjadmin/wjadminpaymenthistory")
@Controller("wjadminwjadminpaymenthistory")
public class WjadminPaymentHistoryController {
    ...
    @ApiOperation("列表")
    @GetMapping("/list")
    @RequiresPermissions("wjadmin:wjadminpaymenthistory:list")
    ...
    @ApiOperation("信息")
    @GetMapping("/info/{id}")
    @RequiresPermissions("wjadmin:wjadminpaymenthistory:info")
    ...
    @ApiOperation("保存")
    @PostMapping("/save")
    @RequiresPermissions("wjadmin:wjadminpaymenthistory:save")
    ...
    @ApiOperation("修改")
    @PostMapping("/update")
    @RequiresPermissions("wjadmin:wjadminpaymenthistory:update")
    ...
    @ApiOperation("删除")
    @PostMapping("/delete")
    @RequiresPermissions("wjadmin:wjadminpaymenthistory:delete")
