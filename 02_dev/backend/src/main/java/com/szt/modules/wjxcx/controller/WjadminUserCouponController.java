...
//import com.szt.modules.wjxcx.entity.WjadminUserCouponEntity;
import com.szt.modules.wjxcx.service.WjadminUserCouponService;
...
@RestController
@RequestMapping("wjxcx/wjadminusercoupon")
@Controller("wjxcxwjadminusercoupon")
public class WjadminUserCouponController {
    ...
    @ApiOperation("列表")
    @GetMapping("/list")
    @RequiresPermissions("wjxcx:wjadminusercoupon:list")
    ...
    @ApiOperation("信息")
    @GetMapping("/info/{id}")
    @RequiresPermissions("wjxcx:wjadminusercoupon:info")
    ...
    @ApiOperation("保存")
    @PostMapping("/save")
    @RequiresPermissions("wjxcx:wjadminusercoupon:save")
    ...
    @ApiOperation("修改")
    @PostMapping("/update")
    @RequiresPermissions("wjxcx:wjadminusercoupon:update")
    ...
    @ApiOperation("删除")
    @PostMapping("/delete")
    @RequiresPermissions("wjxcx:wjadminusercoupon:delete")
