...
import com.szt.modules.wjadmin.service.WjadminReplenishmentPartService;
...
@RestController
@RequestMapping("wjadmin/wjadminreplenishmentpart")
@Controller("wjadminwjadminreplenishmentpart")
public class WjadminReplenishmentPartController {
    ...
    @ApiOperation("列表")
    @GetMapping("/list")
    @RequiresPermissions("wjadmin:wjadminreplenishmentpart:list")
    ...
    @ApiOperation("信息")
    @GetMapping("/info/{id}")
    @RequiresPermissions("wjadmin:wjadminreplenishmentpart:info")
    ...
    @ApiOperation("保存")
    @PostMapping("/save")
    @RequiresPermissions("wjadmin:wjadminreplenishmentpart:save")
    ...
    @ApiOperation("修改")
    @PostMapping("/update")
    @RequiresPermissions("wjadmin:wjadminreplenishmentpart:update")
    ...
    @ApiOperation("删除")
    @PostMapping("/delete")
    @RequiresPermissions("wjadmin:wjadminreplenishmentpart:delete")
