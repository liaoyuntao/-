...
import com.szt.modules.wjadmin.service.WjadminOrderGoodsService;
...
@RestController
@RequestMapping("wjadmin/wjadminordergoods")
@Controller("wjadminwjadminordergoods")
public class WjadminOrderGoodsController {
    ...
    @ApiOperation("列表")
    @GetMapping("/list")
    @RequiresPermissions("wjadmin:wjadminordergoods:list")
    ...
    @ApiOperation("信息")
    @GetMapping("/info/{id}")
    @RequiresPermissions("wjadmin:wjadminordergoods:info")
    ...
    @ApiOperation("保存")
    @PostMapping("/save")
    @RequiresPermissions("wjadmin:wjadminordergoods:save")
    ...
    @ApiOperation("修改")
    @PostMapping("/update")
    @RequiresPermissions("wjadmin:wjadminordergoods:update")
    ...
    @ApiOperation("删除")
    @PostMapping("/delete")
    @RequiresPermissions("wjadmin:wjadminordergoods:delete")
