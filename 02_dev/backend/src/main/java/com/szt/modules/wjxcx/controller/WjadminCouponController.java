...
//import com.szt.modules.wjxcx.entity.WjadminCouponEntity;
import com.szt.modules.wjxcx.service.WjadminCouponService;
...
@RestController
@RequestMapping("wjxcx/wjadmincoupon")
@Controller("wjxcxwjadmincoupon")
public class WjadminCouponController {
    ...
    @ApiOperation("列表")
    @GetMapping("/list")
    @RequiresPermissions("wjxcx:wjadmincoupon:list")
    ...
    @ApiOperation("信息")
    @GetMapping("/info/{id}")
    @RequiresPermissions("wjxcx:wjadmincoupon:info")
    ...
    @ApiOperation("保存")
    @PostMapping("/save")
    @RequiresPermissions("wjxcx:wjadmincoupon:save")
    ...
    @ApiOperation("修改")
    @PostMapping("/update")
    @RequiresPermissions("wjxcx:wjadmincoupon:update")
    ...
    @ApiOperation("删除")
    @PostMapping("/delete")
    @RequiresPermissions("wjxcx:wjadmincoupon:delete")
