...
public class GeneratorTableFieldController {
    ...
    public R list(@RequestParam Map<String, Object> params) {
        PageUtils page = generatorTableFieldService.queryPage(params);
    ...
    public R save(@RequestBody GeneratorTableFieldEntity generatorTableField) {
            ...
            //校验类型
            ValidatorUtils.validateEntity(generatorTableField);
            generatorTableFieldService.insert(generatorTableField);
    ...
    public R update(@RequestBody GeneratorTableFieldEntity generatorTableField) {
            generatorTableField.update();
            //校验类型
             ValidatorUtils.validateEntity(generatorTableField);
            generatorTableFieldService.updateById(generatorTableField);
    ...
    public R delete(@RequestBody Long[]ids) {
            generatorTableFieldService.deleteBatchIds(Arrays.asList(ids));
        return R.ok();
    }
    @SysLog("隐藏表格字段")
    @ApiOperation("隐藏表格字段")
