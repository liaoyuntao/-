 ...
 */
@TableName("xjdc_data_dict")
public class XjdcDataDictEntity implements Serializable {
    ...
    private String typeName;
         ...
         * 分类名称英文
         */
            @NotBlank(message="分类名称英文不能为空")
        @ApiModelProperty(value = "分类名称英文",required = false)
    private String dictNameEnglish;
        /**
         * 备注
         */
    ...
    private Integer sort;
         ...
         * 设置：分类名称英文
         */
        public void setDictNameEnglish(String dictNameEnglish) {
            this.dictNameEnglish = dictNameEnglish;
        }
        /**
         * 获取：分类名称英文
         */
        public String getDictNameEnglish() {
            return dictNameEnglish;
        }
        /**
         * 设置：备注
         */
