...
//
            ...
            try {
                //添加到zip
                zip.putNextEntry(new ZipEntry(getFileName( table.getClassName(),config,template)));
...
//       String naem = getDBKey("1233");
     ...
     * 获取文件名
     */
    public static String getFileName(String className, Map<String, GeneratorTemplateConfigEntity> config,GeneratorTemplateEntity templates) {
