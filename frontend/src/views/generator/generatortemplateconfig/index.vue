<template>
  <div class="mod-config">
    ...
    <tablefield :pathUrl="pathUrl" ref="tablefield" :dataForm.sync="dataForm" :saveForm="saveForm" :setListSelections="setListSelections"  :model="model" :operation.sync="operation"></tablefield>
  </div>
</template>
